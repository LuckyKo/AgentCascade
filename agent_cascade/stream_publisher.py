...
class StreamPublisher:
    ...
    def push_initial_state(self, instance: 'AgentInstance', caller: str) -> None:
    ...
    def push_periodic_update(
        ...
        try:
            ...
            from agent_cascade.api_integration import _put_stream_update, build_stream_update_from_pool
            su = build_stream_update_from_pool(
                pool=self.pool,
    ...
    def push_final_state(self, instance: 'AgentInstance', caller: str) -> None:
