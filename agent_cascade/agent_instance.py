...
class AgentInstance:
    ...
    def reset_conversation(self) -> None:
        ...
        with self._compression_lock:
            ...
            # Memory-hint state resets with the session (feature: memory_hint).
...
class PoolSettings:
    ...
    compression_min_usage_pct: float = COMPRESSION_MIN_USAGE_PCT  # Refuse agent-triggered compression below X% usage
