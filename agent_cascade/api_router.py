...
ENDPOINT_COOLDOWN_SECONDS = int(os.environ.get("AGENT_CASCADE_ENDPOINT_COOLDOWN", "60"))  # Seconds to skip a failed endpoint
        ...
        for cfg_idx, llm_cfg in enumerate(chain):
            ...
            if skipped_early:
                ...
                if ENDPOINT_COOLDOWN_SECONDS > 0:
                    with self._lock:
                        self._endpoint_failure_times[endpoint_base] = time.time()
                    logger.debug(
