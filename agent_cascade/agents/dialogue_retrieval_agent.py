...
from agent_cascade.llm.schema import SYSTEM, USER, ContentItem, Message
from agent_cascade.settings import DEFAULT_WORKSPACE
from agent_cascade.utils.utils import extract_text_from_message, save_text_to_file
...
class DialogueRetrievalAgent(Assistant):
    ...
    def _run(self,
        ...
        file_path = os.path.join(DEFAULT_WORKSPACE,
                                 f'dialogue_history_{session_id}_{datetime.datetime.now():%Y%m%d_%H%M%S}.txt')
