...
from agent_cascade.llm.schema import DEFAULT_SYSTEM_MESSAGE, FUNCTION, USER, ContentItem, Message
...
class VirtualMemoryAgent(Assistant):
    ...
    def _run(self, messages: List[Message], lang: str = 'en', **kwargs) -> Iterator[List[Message]]:
        ...
        while True and num_llm_calls_available > 0:
            ...
            output_stream = self._call_llm(messages=self._format_file(messages) + response, functions=active_functions)
            output: List[Message] = []
