...
The context management logic of Agent Cascade aims to dynamically truncate input messages while maintaining the rationality of the dialogue structure,
...
## Management Strategy
AgentCascade follows the following process to modify the context:
