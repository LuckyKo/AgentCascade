...
def get_version() -> str:
    with open('agent_cascade/__init__.py', encoding='utf-8') as f:
        version = re.search(
            r'^__version__\s*=\s*[\'"]([^\'"]*)[\'"]',
            f.read(),
            re.MULTILINE,
...
setup(
    ...
    description='AgentCascade: Enhancing LLMs with Agent Workflows, RAG, Function Calling, and Code Interpreter.',
    ...
    extras_require={
        ...
        # Extra dependencies for the standalone Telegram bridge (opt-in process):
        'telegram': [
            'python-telegram-bot>=22.8,<22.9',
            'cryptography',
            'httpx',
        ],
