"""
Base Travel Tool - Extension of agent-cascade BaseTool for travel planning
"""
import json
import os
from typing import Dict, List, Optional, Union

# Import base components from agent-cascade framework
from agent_cascade.tools.base import BaseTool, register_tool, TOOL_REGISTRY
...
class BaseTravelTool(BaseTool):
    """
    Base class for travel tools, extending agent-cascade's BaseTool
    
    Design principles:
    1. Inherits from agent-cascade framework's BaseTool
