"""
Agent Orchestrator ΓÇö OrchestratorAgent and sub-agent streaming.
...
Extracted modules:
- agent_pool.py      ΓÇö AgentPool (agent lifecycle + conversation persistence)
- agent_factory.py   ΓÇö Tool registration + agent loading
- agent_logger.py    ΓÇö AgentInstanceLogger (JSONL session logs)
...
# ΓöÇΓöÇΓöÇ Sub-agent function schemas ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇΓöÇ OrchestratorAgent ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
class _SubAgentFunctionProxy(BaseTool):
    ...
    def call(self, params: str, **kwargs) -> str:
        # Should never be reached ΓÇö intercepted in _run
...
class OrchestratorAgent(Assistant):
    ...
    def _truncate_tool_result(
        ...
        # Inline image content (e.g. from screenshot): ![image/png](iVBOR...) ΓÇö skip truncation since it's already compact markdown data, not prose the LLM parses as text tokens.
        ...
        notice = (
            f"\n\n[TOOL RESPONSE TRUNCATED ΓÇö {reason}. "
    ...
    def _stream_sub_agent_call(
        ...
        # ΓöÇΓöÇ Propagate disabled_tools to sub-agent's LLM ΓöÇΓöÇ
        ...
        # ΓöÇΓöÇ Propagate agent settings to sub-agent ΓöÇΓöÇ
        ...
        try:
            ...
            while internal_retries <= max_internal_retries:
                try:
                    # ΓöÇΓöÇ Monkey-patch sub-agent's _call_llm to enforce compression ΓöÇΓöÇ
...
# ΓöÇΓöÇΓöÇ Utility ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇΓöÇ Backward-compatible re-exports ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
