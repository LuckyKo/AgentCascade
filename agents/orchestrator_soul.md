...
follow this 3-step workflow for larger tasks:
  ...
  - POLISH: A SEPARATE optimization phase — see details below. It is NOT optional, NOT skippable, and NOT satisfied by the BUILD-phase review.

POLISH is its own phase:
