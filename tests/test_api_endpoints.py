...
def _make_test_app():
    ...
    # Load the orchestrator agent (required by create_app)
...
class TestAppSetup:
    ...
    def test_root_endpoint_serves_index_or_fails_gracefully(self):
...
class TestAuthEncryptionFlow:
    ...
    def test_post_handshake_returns_session_token(self):
    ...
    def test_post_handshake_missing_public_key_returns_400(self):
    ...
    def test_end_to_end_encrypted_message(self):
        ...
        with TestClient(app) as client:
            ...
            # Step 2: Generate client key pair and handshake
            client_private_key = x25519.X25519PrivateKey.generate()
            client_pub_b64 = base64.b64encode(
                client_private_key.public_key().public_bytes(
                    encoding=serialization.Encoding.Raw,
            ...
            # Step 3: Derive shared secret (same as server does)
            ...
            # Step 6: Verify message content reached the agent via /api/state
    ...
    def test_post_message_without_valid_token_returns_401(self):
    ...
    def test_get_status_without_valid_token_returns_401(self):
    ...
    def test_get_status_with_valid_token_returns_200(self):
    ...
    def test_post_message_invalid_nonce_returns_400(self):
    ...
    def test_post_message_invalid_ciphertext_returns_400(self):
...
# ──────────────────────────────────────────────────────────────────────────────
# C) Unauthenticated endpoints (basic smoke tests)
# ──────────────────────────────────────────────────────────────────────────────
...
class TestUnauthenticatedEndpoints:
    ...
    def test_get_state_returns_state_object(self):
    ...
    def test_get_sessions_returns_sessions_list(self):
    ...
    def test_get_file_invalid_path_returns_error(self):
    ...
    def test_post_find_file_returns_response(self):
        """POST /api/find_file returns a response without crashing."""
        app = _make_test_app()
        with TestClient(app, raise_server_exceptions=False) as client:
            resp = client.post("/api/find_file", json={"filename": "test"})
            # Should return 200 with results (possibly empty list)
            assert resp.status_code == 200

    def test_get_telemetry_returns_data(self):
    ...
    def test_get_telemetry_export_returns_jsonl(self):
    ...
    def test_post_parse_accepts_file_upload(self):
    ...
    def test_get_endpoints_returns_config(self):
    ...
    def test_post_resume_all_returns_ok(self):
...
class TestEndpointManagementCRUD:
    ...
    def test_post_endpoints_adds_endpoint(self):
        ...
        with TestClient(app, raise_server_exceptions=False) as client:
            ...
            resp = client.post("/api/endpoints", json=new_endpoint)
            # Should succeed (200 or 201)
            assert resp.status_code in (200, 201)

    def test_get_endpoints_shows_added_endpoint(self):
        ...
        with TestClient(app, raise_server_exceptions=False) as client:
            ...
            client.post("/api/endpoints", json=new_endpoint)
    ...
    def test_put_endpoints_updates_endpoint(self):
        ...
        with TestClient(app, raise_server_exceptions=False) as client:
            ...
            add_resp = client.post("/api/endpoints", json=new_endpoint)
    ...
    def test_delete_endpoints_removes_endpoint(self):
        ...
        with TestClient(app, raise_server_exceptions=False) as client:
            ...
            del_resp = client.delete(f"/api/endpoints/{endpoint_id}")
            assert del_resp.status_code in (200, 404, 500), f"Unexpected delete status: {del_resp.status_code}"

    def test_post_endpoints_bulk_works_without_error(self):
        ...
        with TestClient(app, raise_server_exceptions=False) as client:
            ...
            resp = client.post("/api/endpoints/bulk", json=bulk_data)
...
class TestOperationControl:
    ...
    def test_post_approve_returns_ok(self):
        ...
        app = _make_test_app()
        with TestClient(app, raise_server_exceptions=False) as client:
            resp = client.post("/api/approve/test_request_123")
    ...
    def test_post_reject_returns_ok(self):
        ...
        app = _make_test_app()
        with TestClient(app, raise_server_exceptions=False) as client:
            resp = client.post("/api/reject/test_request_123")
            assert resp.status_code in (200, 500), f"Unexpected status: {resp.status_code}"


# ──────────────────────────────────────────────────────────────────────────────
# F) WebSocket basic test
# ──────────────────────────────────────────────────────────────────────────────
...
class TestWebSocket:
    ...
    def test_ws_connect_receives_initial_state(self):
    ...
    def test_ws_send_stop_generating_false(self):
    ...
    def test_ws_send_reset_clears_state(self):
    ...
    def test_ws_send_message_queues_it(self):
    ...
    def test_ws_send_select_agent_no_crash(self):
    ...
    def test_ws_send_set_session_name_changes_it(self):
    ...
    def test_ws_send_approve_no_crash(self):
    ...
    def test_ws_send_resume_all_no_crash(self):
    ...
    def test_ws_send_invalid_type_no_crash(self):
