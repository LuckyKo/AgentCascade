...
def test_edit_file_modes():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        res = op_mgr.edit_file(path='test_file.txt',
...
def test_large_file_performance():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        op_mgr.edit_file(path='large_file.txt',
                         agent_name='test_agent',
        ...
        res = op_mgr.edit_file(path='large_file.txt',
                               agent_name='test_agent',
...
def test_heuristic_indentation_alignment():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        file_path_py.write_text('class MyClass:\n'
                                '    def my_func():\n'
                                '        x = 1\n'
                                '        y = 2\n',
                                encoding='utf-8')
        ...
        res = op_mgr.edit_file(path='nested.py',
                               agent_name='test_agent',
                               old_content=old_content,
                               new_content=new_content,
                               match_mode='heuristic')
        ...
        file_path_single.write_text('            x = 1\n', encoding='utf-8')
        op_mgr._own(file_path_single.resolve(), 'test_agent')

        res = op_mgr.edit_file(path='single.py',
                               agent_name='test_agent',
                               old_content='x = 1',
                               new_content='x = 2',
                               match_mode='heuristic')
        ...
        file_path_tabs.write_text('class Foo:\n'
                                  '\tdef bar(self):\n'
                                  '\t\tx = 1\n', encoding='utf-8')
        op_mgr._own(file_path_tabs.resolve(), 'test_agent')

        res = op_mgr.edit_file(path='tabs.py',
                               agent_name='test_agent',
                               old_content='x = 1',
                               new_content='x = 2',
                               match_mode='heuristic')
...
def test_re_indent_shift_mode():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        res = op_mgr.re_indent(path='shift_test.py',
                               agent_name='test_agent',
                               lines='1:3',
                               indent=2,
                               indent_type='space',
