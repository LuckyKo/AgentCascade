...
class TestSlidingWindowRaceConditions:
    ...
    def test_sliding_window_no_duplicate_counting(self, router):
        ...
        threads = [
            threading.Thread(target=lambda: router.call_with_fallback('coder', counting_call))
...
class TestRateLimitEdgeCases:
    ...
    def test_rate_limit_history_is_deque(self, router):
        ...
        with router._lock:
            ...
            assert isinstance(router._endpoint_call_history['http://deque-api'],
                              deque), 'Rate limit history should use deque'
