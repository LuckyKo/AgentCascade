...
def parse_security_response(display_response: str):
    ...
    if verdict_idx != -1:
        ...
        justification = re.sub(r'^(Reason|Justification|Verdict|Tips)[:\s-]*', '', justification,
...
def test_parser():
    test_cases = [
        ...
        },
        {
            ...
            'expected': (
                False, True,
                "Before approving any shell command execution, I need to inspect the actual content of temp_test_coder.py to ensure it doesn't contain malicious or destructive operations. Let me check the file first."
            )
        },
        {
